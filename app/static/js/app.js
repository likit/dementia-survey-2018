...
var ViewModel = function() {
    ...
    self.attd_community = ko.observable();
    self.attd_code = ko.observable();
    self.attd_1 = ko.observable();
    self.attd_2 = ko.observable();
    self.attd_3 = ko.observable();
    self.attd_4 = ko.observable();
    self.attd_5 = ko.observable();
    self.attd_6 = ko.observable();
    self.attd_7 = ko.observable();
    self.attd_8 = ko.observable();
    self.attd_9 = ko.observable();
    self.attd_10 = ko.observable();
    self.attd_11 = ko.observable();

    self.know_1 = ko.observable();
    self.know_2 = ko.observable();
    self.know_3 = ko.observable();
    self.know_4 = ko.observable();
    self.know_5 = ko.observable();
    self.know_6 = ko.observable();
    self.know_7 = ko.observable();
    self.know_8 = ko.observable();
    self.know_9 = ko.observable();
    self.know_10 = ko.observable();
    self.know_11 = ko.observable();
    self.know_12 = ko.observable();
    self.know_13 = ko.observable();
    self.know_14 = ko.observable();
    self.know_15 = ko.observable();
    self.know_16 = ko.observable();
    self.know_17 = ko.observable();
    self.know_18 = ko.observable();
    self.know_19 = ko.observable();
    self.know_20 = ko.observable();
    self.know_21 = ko.observable();
    self.know_22 = ko.observable();
    self.know_23 = ko.observable();
